...
class Narnoo_Distributor_Search_Media_Table extends WP_List_Table {
	...
	function get_current_page_data() {		
		...
		if ( ! is_null( $request ) ) {
			try {
				//$this->search_category, $this->search_subcategory, $this->search_suburb, $this->search_location, $this->search_latitude, $this->search_longitude, $this->search_radius, $this->search_privilege,
				$list = $request->searchMedia( $this->search_media_type, $this->search_media_id, $this->search_keywords, $current_page );
	...
	function prepare_items() {		
		...
		?>
		<div class="narnoo-search-media-box">
		<table>
			<tbody>
				<tr>
					<td colspan="2"><h2>Search for media using the form below:</h2></td>
				</tr>
				<tr>
					<td><label for="search_media_type">Media Type</label></td>
					<td><select id="search_media_type" name="search_media_type">
				...
				<tr>
					<td><label for="search_media_id"><?php _e( 'Media Id:', NARNOO_DISTRIBUTOR_I18N_DOMAIN ); ?></label></td>
					<td><input class="narnoo_text" id="search_media_id" name="search_media_id" type="text" value="<?php echo esc_attr( $this->search_media_id ); ?>" style="width:100%"/></td>
				</tr>
				<tr>
				<td colspan="2" align="center">Or</td>
				</tr>
				<tr>
					<td><label for="search_keywords"><?php _e( 'Keywords:', NARNOO_DISTRIBUTOR_I18N_DOMAIN ); ?></label></td>
					<td><input <?php echo $disabled; ?>class="narnoo_text" id="search_keywords" name="search_keywords" type="text" value="<?php echo esc_attr( $this->search_keywords ); ?>" style="width:100%" placeholder="keyword 1, keyword 2, keyword 3"/></td>
				</tr>
				<tr>
					<td colspan="2"><input id="search-submit" class="button" type="submit" name="search-submit" value="<?php _e( 'search', NARNOO_DISTRIBUTOR_I18N_DOMAIN ); ?>" /></td>
				</tr>
			</tbody>
